...
//#define XPAR_FABRIC_AXI_DMA_1_S2MM_INTROUT_INTR 123U
...
#else
#define RX_INTR_ID		XPAR_FABRIC_AXIDMA_1_MM2S_INTROUT_VEC_ID
#define TX_INTR_ID		XPAR_FABRIC_AXIDMA_1_S2MM_INTROUT_VEC_ID
#endif
